...
class CustomTextFormRequiredAddress extends StatelessWidget {
  const CustomTextFormRequiredAddress({
    Key? key,
            ...
            children: [
              Row(
                children: [
                  Text(
                    nameTag ?? '',
                    style: nameTagStyle ?? AppTextStyle.secondaryText14Medium().copyWith(color: colorTag),
                  ),
                  Text(
                    '*',
                    style: nameTagStyle ?? AppTextStyle.secondaryText14Medium().copyWith(color: colorTag),
